    ...
    <nav class="fixed top-0 w-full z-50 glass-nav">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <a href="#" class="flex items-center gap-3 group">
                <div class="w-10 h-10 rounded-xl bg-primary flex items-center justify-center shadow-lg shadow-primary/20 group-hover:scale-110 transition-transform">
            ...
            <div class="hidden md:flex items-center gap-8">
                <a href="#features" class="text-sm font-medium text-gray-400 hover:text-white transition-colors">Funcionalidades</a>
                <a href="#how-it-works" class="text-sm font-medium text-gray-400 hover:text-white transition-colors">Como Funciona</a>
            </div>

            <div class="flex items-center gap-4">
                <a href="{{ route('login') }}" class="text-sm font-semibold hover:text-primary transition-colors px-4 py-2">Entrar</a>
                <a href="{{ route('register') }}" class="bg-primary hover:bg-blue-600 px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg shadow-primary/20 hover:shadow-primary/40 active:scale-95">
                    Começar Agora
                </a>
            </div>
        </div>
    ...
    <section class="relative pt-32 pb-20 overflow-hidden min-h-screen flex items-center">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1]">
                Domine seu <span class="bg-gradient-to-r from-primary to-cyan-400 bg-clip-text text-transparent animate-gradient">Repertório Musical</span>
            </h1>

            <p class="text-xl text-gray-400 max-w-2xl mx-auto mb-12 leading-relaxed">
                A ferramenta definitiva para músicos e bandas organizarem shows, gerenciarem setlists e focarem no que realmente importa: a música.
            </p>

            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-primary text-white font-extrabold text-lg shadow-2xl shadow-primary/30 hover:bg-blue-600 transition-all active:scale-95 flex items-center justify-center gap-2">
                    Criar Minha Conta Grátis
                    <span class="material-symbols-outlined">arrow_forward</span>
                </a>
                <a href="#features" class="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/5 border border-white/10 font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
                    Ver Funcionalidades
                </a>
            </div>
            ...
            <div class="mt-20 relative max-w-5xl mx-auto animate-float">
                ...
                <div class="rounded-3xl border border-white/10 bg-dark-card/50 backdrop-blur-sm p-4 shadow-2xl overflow-hidden aspect-video flex items-center justify-center text-gray-500 border-dashed border-2">
    ...
    <section id="features" class="py-32 bg-dark-bg/50">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    ...
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Crie e organize múltiplos repertórios por shows, eventos ou estilos. Mantenha suas músicas sempre à mão de forma rápida e intuitiva.
                    </p>
                </div>

                <!-- Feature 2 -->
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center text-cyan-400">
                        <span class="material-symbols-outlined text-3xl">grid_view</span>
                    </div>
                    <h3 class="text-2xl font-bold">Organização em Blocos</h3>
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Estruture seu show em blocos temáticos ou por dinâmica de palco. Perfeito para gerenciar momentos de energia alta ou sets acústicos.
                    </p>
                </div>
                ...
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    ...
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Gere links públicos instantâneos para compartilhar o setlist com sua banda, contratantes ou público sem que eles precisem de login.
                    </p>
                </div>
                ...
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    ...
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Transforme seu repertório em documentos PDF profissionais com um clique. Pronto para imprimir ou usar em tablets offline durante a performance.
                    </p>
                </div>

                <!-- Feature 5 -->
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-emerald-400/10 border border-emerald-400/20 flex items-center justify-center text-emerald-400">
                        <span class="material-symbols-outlined text-3xl">lightbulb</span>
                    </div>
                    <h3 class="text-2xl font-bold">Sugestões Inteligentes</h3>
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Receba insights automáticos baseados nas suas músicas favoritas para criar a sequência perfeita (Crossover, BPM, etc).
                    </p>
                </div>

                <!-- Feature 6 -->
                <div class="feature-card p-8 rounded-3xl bg-dark-card border border-white/5 flex flex-col items-start gap-4">
                    <div class="w-14 h-14 rounded-2xl bg-pink-500/10 border border-pink-500/20 flex items-center justify-center text-pink-500">
                        <span class="material-symbols-outlined text-3xl">sync</span>
                    </div>
                    <h3 class="text-2xl font-bold">Multi-Dispositivo</h3>
                    <p class="text-gray-400 leading-relaxed text-sm">
                        Acesse seus dados de qualquer lugar, seja no PC, tablet ou smartphone. Seus ensaios e apresentações sempre sincronizados.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-32 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a href="{{ route('register') }}" class="w-full sm:w-auto px-10 py-5 rounded-2xl bg-primary text-white font-black text-xl shadow-2xl shadow-primary/40 hover:scale-105 transition-all flex items-center justify-center gap-3">
